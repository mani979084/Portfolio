            ...
            <section className="about section " id="about">
                ...
                <div className="about__container bd-grid about__margin">
                    <div>
                        ...
                        <p className="about__text text-secondary">I'm passionate about creating interesting web assets with a strong emphasis on clean code.</p></div>
                </div>
                <div className="about__container bd-grid about__margin">
                ...
                <div className="about__container bd-grid">
                    ...
                    <div id='about_order_1'>
                        ...
                        <p className="about__text about__text2 text-secondary ">My knowledge of back-end development allows me to build APIs, databases, and other server-side related features. These techniques help me create full applications that not only handle a vast amount of data but are able to serve it in a secure, optimized way.
